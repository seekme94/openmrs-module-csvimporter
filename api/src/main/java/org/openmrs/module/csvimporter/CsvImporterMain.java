...
public class CsvImporterMain {
	...
	public static void main(String[] args) {
		...
		// Person
		map.add(new CsvImporterMapping(2, new Date(), user, null, null, configuration, "age", OpenMrsObjectCategory.PERSON,
		        "age", null));
		map.add(new CsvImporterMapping(3, new Date(), user, null, null, configuration, "dob", OpenMrsObjectCategory.PERSON,
		        "date_of_birth", null));
		map.add(new CsvImporterMapping(4, new Date(), user, null, null, configuration, "gender",
		        OpenMrsObjectCategory.PERSON, "gender", null));
		map.add(new CsvImporterMapping(6, new Date(), user, null, null, configuration, "form_date",
		        OpenMrsObjectCategory.PERSON, "date_created", null));
		// Person Names
		map.add(new CsvImporterMapping(0, new Date(), user, null, null, configuration, "first_name",
		        OpenMrsObjectCategory.PERSON_NAME, "given_name", null));
		map.add(new CsvImporterMapping(1, new Date(), user, null, null, configuration, "surname",
		        OpenMrsObjectCategory.PERSON_NAME, "family_name", null));
		// Person Address
		map.add(new CsvImporterMapping(7, new Date(), user, null, null, configuration, "address",
		        OpenMrsObjectCategory.PERSON_ADDRESS, "address1", null));
		map.add(new CsvImporterMapping(7, new Date(), user, null, null, configuration, "city",
		        OpenMrsObjectCategory.PERSON_ADDRESS, "city_village", null));
		map.add(new CsvImporterMapping(7, new Date(), user, null, null, configuration, "country",
		        OpenMrsObjectCategory.PERSON_ADDRESS, "country", null));
		// Person attributes
		map.add(new CsvImporterMapping(7, new Date(), user, null, null, configuration, "phone1",
		        OpenMrsObjectCategory.PERSON_ATTRIBUTE, "Primary Phone", null));
		map.add(new CsvImporterMapping(7, new Date(), user, null, null, configuration, "facility_name",
		        OpenMrsObjectCategory.PERSON_ATTRIBUTE, "Location", null));
		map.add(new CsvImporterMapping(7, new Date(), user, null, null, configuration, "suspect",
		...
		for (int i = 0; i < definedAttributes.size(); i++) {
			personAttributeTypes[i] = Context.getPersonService().getPersonAttributeTypeByName(
			    definedAttributes.get(i).getObjectName());
		}
